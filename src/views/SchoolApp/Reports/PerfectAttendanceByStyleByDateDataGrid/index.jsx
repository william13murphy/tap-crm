...
type PerfectAttendanceByStyleByDateDataGridProps = {
  data: {
    payload: Array<{}>,
  },
  history: {
...
class PerfectAttendanceByStyleByDateDataGrid extends React.Component {
  props: PerfectAttendanceByStyleByDateDataGridProps;
    ...
    if (
      ...
      return (
        <div className="InventoryGrid">
          <h4>No Perfect Attendance Report Found</h4>
        </div>
      );
    }
            ...
            onClick: () => {
              if (column.Header === 'Email') {
                this.props.history.push({
                  pathname: `/app/school-app/${schoolId}/reports/perfect-attendance-report/send-email`,
              ...
              } else if (column.Header === 'PhoneNumber') {
                this.props.history.push({
                  pathname: `/app/school-app/${schoolId}/reports/perfect-attendance-report/send-sms`,
