...
class RenewalDataGrid extends React.Component {
  props: RenewalDataGridProps;
  state = {
    data: [],
    columns: [
      {
  ...
  render() {
    ...
    return (
      <div className="RenewalDataGrid__container">
        <Link
        ...
        <DefaultReactTable
          ...
          className="RenewalDataGrid linked-row"
...
export default RenewalDataGrid;
