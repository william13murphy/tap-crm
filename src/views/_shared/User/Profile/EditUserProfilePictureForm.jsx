...
class EditUserProfilePictureForm extends React.Component {
  props: EditUserProfilePictureFormProps;
...
const connectedEditUserProfilePictureForm = connect(
...
export default reduxForm({
  ...
  validate,
})(connectedEditUserProfilePictureForm);
